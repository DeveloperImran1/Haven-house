    ...
    return (
        <div id="contact">
            <h1 data-aos="fade-up"
                ...
                className="text-[40px] mb-6 lg:mb-9 font-bold text-[#131313] text-center">Contact Us</h1>
            <div className="grid max-w-screen-xl grid-cols-1 gap-8 px-8 py-16 mx-auto rounded-lg md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 bg-gray-100 text-gray-800">
                <div className="flex flex-col justify-between">
                    <div className="space-y-2">
                        ...
                        <div className="dark:text-gray-600">If you know more information? Please Contact Us.</div>
                    </div>
                    <h2 className=" font-bold leading-tight mt-[26px] text-2xl">Find Us!</h2>
                ...
                <form onSubmit={handleSubmit} noValidate="" className="space-y-6">
                    ...
                    <button 
                     ...
                     data-aos-easing="ease-in-out"
                     data-aos-mirror="true"
                    type="submit" className="w-full p-3 text-sm font-bold tracking-wide uppercase rounded bg-violet-600 text-gray-50">Send Message</button>
                </form>
            </div>
        </div>
    );
