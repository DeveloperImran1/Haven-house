...
const Footer = () => {
    return (
        ...
        <nav className="grid grid-cols-3 lg:grid-cols-6  gap-4">
          <a href="#states"><a className="link link-hover">States</a></a>
          <a href="#clients"><a className="link link-hover">Satisfied Clients</a></a>
          <a href="#contact"><a className="link link-hover">Contact Us</a></a>
          <a href="/profile"><a className="link link-hover">Profile</a></a>
          <a href="/updateProfile"><a className="link link-hover">Update Profile</a></a>
          <a href="/login"><a className="link link-hover">Login</a></a>
        ...
        <aside>
          <p>Copyright © 2024 - All right reserved by  <h2 className='text-sky-500'><span className='text-green-500'>Haven</span>House</h2> Ltd</p>
        </aside>
      </footer>
